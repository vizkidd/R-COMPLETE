...
# Copyright (C) 2007-2020 vsuresh, Ole Tange, http://ole.tange.dk
...
cat <<'cut-here-T5y5pprqZtHstZZ9YElb' > $_file_with_GNU_Parallel_source
#!/usr/bin/env perl
